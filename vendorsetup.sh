...
git clone https://github.com/Kneba/device_asus_sdm660-common -b perf device/asus/sdm660-common

# Clone vendor tree
rm -rf vendor/asus
git clone --single-branch https://github.com/Kneba/proprietary_vendor_asus -b perf vendor/asus
